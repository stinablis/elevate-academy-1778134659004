...
const basePath = '/elevate-academy-1778134659004';
...
export default function Home() {
  ...
  const submit = (e: any) => {
    ...
    window.open(`https://wa.me/60189012345?text=${msg}`, '_blank');
  };
  ...
  const products = [{ n: 'STEM Tuition', d: 'Science and math for primary and secondary', i: 'https://images.pexels.com/photos/8471988/pexels-photo-8471988.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'English Enrichment', d: 'Reading, writing, and communication skills', i: 'https://images.pexels.com/photos/5427868/pexels-photo-5427868.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Coding for Kids', d: 'Scratch and Python for ages 8-16', i: 'https://images.pexels.com/photos/4705629/pexels-photo-4705629.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'University Prep', d: 'SPM and A-Level intensive programmes', i: 'https://images.pexels.com/photos/6684506/pexels-photo-6684506.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Online Classes', d: 'Live interactive sessions via Zoom', i: 'https://images.pexels.com/photos/4226256/pexels-photo-4226256.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">Elevate Academy</span>
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/36159720/pexels-photo-36159720.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              Learning that lasts <span className="text-accent">a lifetime..</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              Elevate Academy delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/60189012345`}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Elevate Academy, we are dedicated to providing high-quality educational services that foster a lifelong love of learning. Our experienced team is passionate about empowering students to reach their full potential through engaging and interactive lessons. By nurturing curiosity and promoting academic excellence, we aim to make a positive impact on the lives of our students and the wider community.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become a leading provider of innovative and effective educational solutions, inspiring a generation of curious, empowered, and knowledgeable individuals.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver exceptional educational experiences that cultivate curiosity, promote empowerment, and support the academic and personal growth of our students, helping them to succeed in an ever-changing world.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Curiosity</h4>
                  <p className="text-sm text-on-surface-variant">We nurture the love of learning.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Empowerment</h4>
                  <p className="text-sm text-on-surface-variant">Knowledge that opens doors.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/35769752/pexels-photo-35769752.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/545068/pexels-photo-545068.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/6503100/pexels-photo-6503100.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">enroll@elevateacademy.com</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">60189012345</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">Elevate Academy</div>
            <p className="text-white/60 text-sm leading-relaxed">Learning that lasts a lifetime.</p>
          </div>
          <div className="flex justify-center md:justify-center gap-6">
            
            
            <a href={`https://wa.me/60189012345`} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">WhatsApp</a>
          </div>
